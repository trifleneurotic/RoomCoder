        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    current_code_number = table.Column<byte>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    code1 = table.Column<ushort>(type: "INTEGER", nullable: false),
                    code2 = table.Column<ushort>(type: "INTEGER", nullable: false),
                    code3 = table.Column<ushort>(type: "INTEGER", nullable: false),
                    code4 = table.Column<ushort>(type: "INTEGER", nullable: false),
                    code5 = table.Column<ushort>(type: "INTEGER", nullable: false),
                    code6 = table.Column<ushort>(type: "INTEGER", nullable: false),
                    code7 = table.Column<ushort>(type: "INTEGER", nullable: false),
                    room_number = table.Column<byte>(type: "INTEGER", nullable: false),
                    created_at = table.Column<DateTime>(type: "TEXT", nullable: false),
                    updated_at = table.Column<DateTime>(type: "TEXT", nullable: true)
                },
